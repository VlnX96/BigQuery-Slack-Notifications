...
LIMIT 100;`;
  ...
  let noResultCountAndroid = rows[1].no_result;
  let firstOpenCountAndroid = rows[1].first_open;
  let resultFoundCountAndroid = rows[1].result_found;
  let accountCreatedCountAndroid = rows[1].account_created;
  let sessionStartCountAndroid = rows[1].session_start;
    ...
    blocks: [
      ...
      },
      {
        ...
        "fields": [
          ...
          {
            "type": "plain_text",
            "text": `First Opens : ${firstOpenCountAndroid}`,
          },
          {
            "type": "plain_text",
          ...
          {
            "type": "plain_text",
            "text": `Sessions Started : ${sessionStartCountAndroid}`,
          },
          {
            "type": "plain_text",
          ...
          {
            "type": "plain_text",
            "text": `Accounts Created : ${accountCreatedCountAndroid}`,
          },
          {
            "type": "plain_text",
          ...
          {
            "type": "plain_text",
            "text": `Results Found : ${resultFoundCountAndroid}`,
          },
          {
            "type": "plain_text",
          ...
          {
            "type": "plain_text",
            "text": `No Results : ${noResultCountAndroid}`,
          }
        ]
      }
    ],
